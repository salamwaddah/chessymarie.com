<footer class="bg-gray-100 shadow-inner py-5 px-3">
    <div class="max-w-screen-lg mx-auto sm:px-8 flex flex-col md:flex-row justify-between">
        <div class="flex flex-col flex flex-col mb-4 md:mb-0">
            Chessy Marie - A registered nurse
        </div>
        <div class="flex flex-col mb-4 md:mb-0 mx-auto">
            <a href="https://www.linkedin.com/in/chessymarie/" target="_blank" rel="noopener nofollow" class="w-6 mx-1" aria-label="Chessy Marie LinkedIn profile" title="Chessy Marie LinkedIn profile">
                <svg class="fill-current cursor-pointer text-gray-500 hover:text-gray-400" width="100%" height="100%" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" xml:space="preserve" style="fill-rule: evenodd; clip-rule: evenodd; stroke-linejoin: round; stroke-miterlimit: 2;">
        ...
        <div class="flex flex-col">
            <a href="https://salamwaddah.com/" aria-label="The developer of this website" title="Salam Waddah's website">Developed by Salam</a>
        </div>
    </div>
</footer>
