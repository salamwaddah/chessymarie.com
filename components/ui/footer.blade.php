<footer class="bg-gray-100 shadow-inner py-5 px-3">
    <div class="max-w-screen-lg mx-auto sm:px-8 flex flex-col md:flex-row justify-between">
        ...
        <div class="flex flex-col mb-4 md:mb-0 mx-auto">
            <a href="https://www.linkedin.com/in/chessymarie/" target="_blank" rel="nofollow" class="w-6 mx-1" aria-label="Chessy Marie LinkedIn profile" title="Chessy Marie LinkedIn profile">
