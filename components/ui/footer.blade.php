<footer class="bg-gray-100 shadow-inner">
    <div class="sm:flex sm:mt-8  py-5 px-3 mt-8 sm:mt-0 sm:w-full sm:px-8 flex flex- max-w-screen-lg col md:flex-row justify-between mx-auto">
        <div class="flex flex-col mb-4 sm:m-0">
            Chessy Marie - A registered nurse
        </div>
        <div class="flex flex-col mb-4 sm:m-0 mx-auto">
